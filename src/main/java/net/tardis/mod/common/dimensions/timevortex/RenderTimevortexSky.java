...
public class RenderTimevortexSky extends IRenderHandler {
	
	private static final ResourceLocation SUN = new ResourceLocation(Tardis.MODID, "textures/environment/sun.png");
	private static final ResourceLocation DAY = new ResourceLocation(Tardis.MODID, "textures/environment/timevortex_sky_day.png");
	private static final ResourceLocation NIGHT = new ResourceLocation(Tardis.MODID, "textures/environment/timevortex_sky_night.png");
	
	public static Sphere SKY = new Sphere();
	
	private static RenderTimevortexSky SKY_RENDER = new RenderTimevortexSky();
	
	public static RenderTimevortexSky getInstance(){
		return SKY_RENDER;
	}
