...
public class TileEntityEPanelRoom extends TileEntity implements ITickable, IInventory {

	public int stateID = Block.getStateId(TBlocks.epanel_room.getDefaultState());

	public TileEntityEPanelRoom() {
	}
