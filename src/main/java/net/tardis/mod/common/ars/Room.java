...
public class Room {
	...
	public Room(ResourceLocation preview, ResourceLocation filePath, BlockPos cp) {
	...
	public static void registerRoom(String previewPath, String interiorName, BlockPos pos) {
		ROOMS.add(new Room(new ResourceLocation(Tardis.MODID, previewPath), new ResourceLocation(Tardis.MODID, interiorName), pos));
	}
}
